...
class TextHelperSplitActionTest {
    ...
    @Test
    void testPerformWithEmptyDelimiter() {
        Parameters parameters = MockParametersFactory.create(Map.of(TEXT, "apple", DELIMITER, ""));
        String[] result = TextHelperSplitAction.perform(parameters, parameters, mock(ActionContext.class));
    ...
    @Test
    void testPerformWithMultipleDelimiters() {
        Parameters parameters = MockParametersFactory.create(Map.of(TEXT, "apple,,banana", DELIMITER, ","));
        String[] result = TextHelperSplitAction.perform(parameters, parameters, mock(ActionContext.class));
