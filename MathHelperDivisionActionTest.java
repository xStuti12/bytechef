...
class MathHelperDivisionActionTest {
    ...
    @Test
    void testPerformWithSmallNumbers() {
        Parameters mockedParameters = MockParametersFactory.create(Map.of(FIRST_NUMBER, 0.001, SECOND_NUMBER, 0.0001));
        Double result = MathHelperDivisionAction.perform(mockedParameters, mockedParameters, mock(ActionContext.class));
        assertEquals(10.0, result);
    }

    @Test
    void testPerformWithLargeNumbers() {
        Parameters mockedParameters = MockParametersFactory.create(Map.of(FIRST_NUMBER, 1e9, SECOND_NUMBER, 2));
        Double result = MathHelperDivisionAction.perform(mockedParameters, mockedParameters, mock(ActionContext.class));
        assertEquals(5e8, result);
    }
