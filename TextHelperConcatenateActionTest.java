...
class TextHelperConcatenateActionTest {
    ...
    @Test
    void testPerformWithSingleText() {
        Parameters parameters = MockParametersFactory.create(Map.of(TEXTS, List.of("single")));
        String result = TextHelperConcatenateAction.perform(parameters, parameters, mock(ActionContext.class));
        assertEquals("single", result);
    }

    @Test
    void testPerformWithEmptyList() {
        Parameters parameters = MockParametersFactory.create(Map.of(TEXTS, List.of(), SEPARATOR, ", "));
        String result = TextHelperConcatenateAction.perform(parameters, parameters, mock(ActionContext.class));
        assertEquals("", result);
    }

    @Test
    void testPerformWithNullSeparator() {
        Parameters parameters = MockParametersFactory.create(Map.of(TEXTS, List.of("A", "B", "C")));
        String result = TextHelperConcatenateAction.perform(parameters, parameters, mock(ActionContext.class));
