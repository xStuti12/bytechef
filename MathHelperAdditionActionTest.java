...
class MathHelperAdditionActionTest {
    ...
    void testPerformWithNegativeNumbers() {
        Parameters mockedParameters = MockParametersFactory.create(Map.of(FIRST_NUMBER, -5, SECOND_NUMBER, -3));
        Double result = MathHelperAdditionAction.perform(mockedParameters, mockedParameters, mock(ActionContext.class));
        assertEquals(-8.0, result);
    }

    @Test
    void testPerformWithDecimals() {
        Parameters mockedParameters = MockParametersFactory.create(Map.of(FIRST_NUMBER, 1.5, SECOND_NUMBER, 2.5));
        Double result = MathHelperAdditionAction.perform(mockedParameters, mockedParameters, mock(ActionContext.class));
